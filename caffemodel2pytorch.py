...
caffe_pb2 = None
## 提前从https://raw.githubusercontent.com/BVLC/caffe/master/src/caffe/proto/caffe.proto下载好caffe.proto文件
def initialize(caffe_proto='path/to/your/local/caffe.proto', codegen_dir=tempfile.mkdtemp(), shadow_caffe=True):
    global caffe_pb2
    if caffe_pb2 is None:
        ...
        with open(local_caffe_proto, 'w') as f:
            with open(caffe_proto, 'r') as local_file:
                mystr = local_file.read()
                f.write(mystr)
...
if __name__ == '__main__':
	...
	net_param = initialize("caffe.proto").NetParameter()
